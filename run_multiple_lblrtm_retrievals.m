function [] = run_multiple_lblrtm_retrievals(datestring)
    ...
    utc_profile = datestring; % e.g., '202502120753'
    ...
    % MODTRAN/LBLRTM paths and settings
    ...
    start_idx = find(time_diff >= -2, 1, 'first'); % start (~ 1 minute before launch)
    end_idx = find(time_diff <= 8, 1, 'last');    % end (10 minutes after launch)
